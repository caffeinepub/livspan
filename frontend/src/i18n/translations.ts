...
export const translations: Record<Language, Translations> = {
  ...
  de: {
    ...
    sleepPanel: {
      ...
      authRequired: 'Bitte melde dich an, um deinen täglichen Schlaf zu verfolgen.',
      duration: {
        label: 'Schlafdauer',
        unit: 'h',
    ...
    movementPanel: {
      ...
      authRequired: 'Bitte melde dich an, um deine tägliche Bewegung zu verfolgen.',
      activeMinutes: {
    ...
    stressPanel: {
      ...
      authRequired: 'Bitte melde dich an, um deine täglichen Vitalwerte zu verfolgen.',
      bloodPressure: {
        label: 'Blutdruck',
        systolic: 'Systolisch',
